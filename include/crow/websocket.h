...
namespace crow
{
    namespace websocket
    {
		...
		struct connection_base : public boost::enable_shared_from_this<connection_base> {
    ...
    using connection = boost::shared_ptr<connection_base>;
        ...
        class Connection : public connection_base
        {
            ...
            std::string&& hello = crow::utility::base64encode((char*)digest, 20);
                    ...
                    do_write();
                    if (open_handler_)
                        open_handler_(boost::dynamic_pointer_cast<Connection<Adaptor>>(shared_from_this()));
                    do_read();
                }
                ...
                {
                    dispatch([this, _ = boost::dynamic_pointer_cast<Connection<Adaptor>>(shared_from_this()), msg]{
                        char buf[3] = "\x8A\x00";
                        buf[1] += msg.size();
                ...
                void close(const std::string& msg) override
                {
                    dispatch([this, _ = boost::dynamic_pointer_cast<Connection<Adaptor>>(shared_from_this()), msg]{
                        ...
                        if (has_recv_close_ && !is_close_handler_called_)
                        {
                            ...
                            if (close_handler_)
                                close_handler_(boost::dynamic_pointer_cast<Connection<Adaptor>>(shared_from_this()), msg);
                        }
            ...
            protected:
                        ...
                        case WebSocketReadState::MiniHeader:
                            {
                                ...
                                adaptor_.socket().async_read_some(boost::asio::buffer(&mini_header_, 2), 
                                    [this, _ = boost::dynamic_pointer_cast<Connection<Adaptor>>(shared_from_this())](const boost::system::error_code& ec, std::size_t 
...

                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            adaptor_.close();
                                            if (error_handler_)
                                                error_handler_(boost::dynamic_pointer_cast<Connection<Adaptor>>(shared_from_this()));
                                            check_destroy();
                                        }
                                    });
                            }
                        ...
                        case WebSocketReadState::Payload:
                            {
                                ...
                                adaptor_.socket().async_read_some( boost::asio::buffer(buffer_, to_read), 
                                    [this, _ = boost::dynamic_pointer_cast<Connection<Adaptor>>(shared_from_this())](const boost::system::error_code& ec, std::size_t bytes_transferred)
                                    {
                                        is_reading = false;
                        ...
                        case 0: // Continuation
                            {
                                ...
                                {
                                    if (message_handler_)
                                        message_handler_(boost::dynamic_pointer_cast<Connection<Adaptor>>(shared_from_this()), message_, is_binary_);
                                    message_.clear();
                                }
                            }
                        case 1: // Text
                        ...
                        case 0x8: // Close
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        if (close_handler_)
                                            close_handler_(boost::dynamic_pointer_cast<Connection<Adaptor>>(shared_from_this()), fragment_);
                                        is_close_handler_called_ = true;
                                    }
                                    check_destroy();
                                }
                ...
                void check_destroy()
                {
                    ...
                    if (!is_close_handler_called_)
                        if (close_handler_)
                            close_handler_(boost::dynamic_pointer_cast<Connection<Adaptor>>(shared_from_this()), "uncleanly");
